...
@Component
public class SyncBatchIncrementalLoader extends SyncBatchLoader {
    @Override
    protected List<ControlInfo> fetchControlInfo(final EDPSourceSystem edpSourceSystem) {
        return controlInfoRepository.fetchAllByStatus("SUCCESS", edpSourceSystem.getMetadataRefreshDate());
    }
